...
import { create } from '../fn/producto-ingreso-producto-controller/create';
import { Create$Params } from '../fn/producto-ingreso-producto-controller/create';
import { delete$ } from '../fn/producto-ingreso-producto-controller/delete';
import { Delete$Params } from '../fn/producto-ingreso-producto-controller/delete';
import { find } from '../fn/producto-ingreso-producto-controller/find';
import { Find$Params } from '../fn/producto-ingreso-producto-controller/find';
import { IngresoProducto } from '../models/ingreso-producto';
import { Count as LoopbackCount } from '../models/loopback/count';
import { patch } from '../fn/producto-ingreso-producto-controller/patch';
import { Patch$Params } from '../fn/producto-ingreso-producto-controller/patch';

@Injectable({ providedIn: 'root' })
export class ProductoIngresoProductoControllerService extends BaseService {
  constructor(config: ApiConfiguration, http: HttpClient) {
    super(config, http);
  }

  /** Path part for operation `productoIngresoProductoControllerFind()` */
  static readonly ProductoIngresoProductoControllerFindPath = '/productos/{id}/ingreso-productos';
  ...
  /** Path part for operation `productoIngresoProductoControllerCreate()` */
  static readonly ProductoIngresoProductoControllerCreatePath = '/productos/{id}/ingreso-productos';
  ...
  /** Path part for operation `productoIngresoProductoControllerDelete()` */
  static readonly ProductoIngresoProductoControllerDeletePath = '/productos/{id}/ingreso-productos';
  ...
  /** Path part for operation `productoIngresoProductoControllerPatch()` */
  static readonly ProductoIngresoProductoControllerPatchPath = '/productos/{id}/ingreso-productos';
