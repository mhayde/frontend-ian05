...
import { getProveedor } from '../fn/producto-proveedor-controller/get-proveedor';
import { GetProveedor$Params } from '../fn/producto-proveedor-controller/get-proveedor';
import { Proveedor } from '../models/proveedor';

@Injectable({ providedIn: 'root' })
export class ProductoProveedorControllerService extends BaseService {
  constructor(config: ApiConfiguration, http: HttpClient) {
    super(config, http);
  }

  /** Path part for operation `productoProveedorControllerGetProveedor()` */
  static readonly ProductoProveedorControllerGetProveedorPath = '/productos/{id}/proveedor';
