...
import { getProducto } from '../fn/retiro-producto-producto-controller/get-producto';
import { GetProducto$Params } from '../fn/retiro-producto-producto-controller/get-producto';
import { Producto } from '../models/producto';

@Injectable({ providedIn: 'root' })
export class RetiroProductoProductoControllerService extends BaseService {
  constructor(config: ApiConfiguration, http: HttpClient) {
    super(config, http);
  }

  /** Path part for operation `retiroProductoProductoControllerGetProducto()` */
  static readonly RetiroProductoProductoControllerGetProductoPath = '/retiro-productos/{id}/producto';
