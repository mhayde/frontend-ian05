...
import { create } from '../fn/venta-retiro-producto-controller/create';
import { Create$Params } from '../fn/venta-retiro-producto-controller/create';
import { delete$ } from '../fn/venta-retiro-producto-controller/delete';
import { Delete$Params } from '../fn/venta-retiro-producto-controller/delete';
import { find } from '../fn/venta-retiro-producto-controller/find';
import { Find$Params } from '../fn/venta-retiro-producto-controller/find';
import { Count as LoopbackCount } from '../models/loopback/count';
import { patch } from '../fn/venta-retiro-producto-controller/patch';
import { Patch$Params } from '../fn/venta-retiro-producto-controller/patch';
import { RetiroProducto } from '../models/retiro-producto';

@Injectable({ providedIn: 'root' })
export class VentaRetiroProductoControllerService extends BaseService {
  constructor(config: ApiConfiguration, http: HttpClient) {
    super(config, http);
  }

  /** Path part for operation `ventaRetiroProductoControllerFind()` */
  static readonly VentaRetiroProductoControllerFindPath = '/ventas/{id}/retiro-productos';
  ...
  /** Path part for operation `ventaRetiroProductoControllerCreate()` */
  static readonly VentaRetiroProductoControllerCreatePath = '/ventas/{id}/retiro-productos';
  ...
  /** Path part for operation `ventaRetiroProductoControllerDelete()` */
  static readonly VentaRetiroProductoControllerDeletePath = '/ventas/{id}/retiro-productos';
  ...
  /** Path part for operation `ventaRetiroProductoControllerPatch()` */
  static readonly VentaRetiroProductoControllerPatchPath = '/ventas/{id}/retiro-productos';
